...
//    public static final String File_KEY="FILES_FRONT_ALL";
    ...
    public Result frontAll(){
        ...
        if(StringUtils.isBlank(jsonStr)){
            ...
            stringRedisTemplate.opsForValue().set(Constants.File_KEY, JSONUtil.toJsonStr(files));
        }else{
